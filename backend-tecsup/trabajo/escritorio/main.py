...
mydb = mysql.connector.connect(
    host="b8jbbodxdpfnz8shn5hf-mysql.services.clever-cloud.com",
    user="uxokmefkdrcvisu2",
    password="t4FSTmb1DcZEv71EvsId",
    database="b8jbbodxdpfnz8shn5hf"
)
...
class App:
    ...
    def __init__(self, root):
        ...
        self.nombre = GLineEdit_534
        self.cargo = GLineEdit_230
        #self.timestamp = GLineEdit_55
    ...
    def GButton_974_command(self):
        sqlInsertar = "insert into asistencias(Nombre,Cargo) values(%s,%s)"
        parametros = (self.nombre.get(),self.cargo.get())
        print(sqlInsertar)
        print(parametros)
        self.ejecutarSql(sqlInsertar,parametros)
        messagebox.showinfo("Registro Exitoso", "asistencia registrada con Exito")
